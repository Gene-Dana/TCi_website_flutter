...
import 'package:TCi/views/critical_care/title_page_content.dart';
  ...
  void _onDragUpdate(DragUpdateDetails details) {
    ...
    if (details.primaryDelta < -1) {
      ...
      if (animationController.isDismissed && !drawer) {
        int current = widget.controller.page.toInt();
        print(current);
        widget.controller.animateToPage(current + 1,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TitlePageContent()),
                      );
                      print('hi');
                    },
                    child: Image.asset("/ccare-button.png"),
                  ),
